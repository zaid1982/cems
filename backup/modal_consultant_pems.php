                        ...
                        <article class="col-sm-12 col-md-12 col-lg-12">
                            <div class="widget-body fuelux">
                                ...
                                <ul class="steps">
                                    ...
                                    <li data-target="#map_step4" class="font-sm">
                            ...
                            <div class="step-content padding-10 padding-bottom-0 minHeight">                                            
                                ...
                                <div class="step-pane" id="map_step2" data-step="2">
                                    <form class="form-horizontal" id="form_map_2_1" method="post">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12"> 
                                                ...
                                                <div class="form-group">
                                                    <label class="col-md-3 control-label"><font color="red">*</font> Mobile-CEMS/Portable Model No.</label>
                                                    <div class="col-md-9 selectContainer">
                                    ...
                                    <form class="form-horizontal" id="form_map_2_3" method="post">
                                        <div class="row padding-top-15">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7 map_checkView">
                                                        <div class="input-group pull-right">
                                                            <input class="form-control map_form_check" placeholder="Remark" type="text" name="map_check_remark_16" id="map_check_remark_16">
                                                            <span class="input-group-addon">
                                                                <span class="onoffswitch">
                                                                    <input type="checkbox" class="onoffswitch-checkbox map_form_check" name="map_check_pass_16" id="map_check_pass_16">
                                                                    <label class="onoffswitch-label" for="map_check_pass_16"> 
                                                                        <span class="onoffswitch-inner" data-swchon-text="Pass" data-swchoff-text="Fail"></span> 
                                                                        <span class="onoffswitch-switch"></span> 
                                                                    </label> 
                                                                </span>
                                        ...
                                        <div class="well margin-bottom-15 padding-bottom-0 map_hideView">
                                            <div class="row margin-bottom-15">                                                
                                                <div class="col-md-12">
                                                    <small class="map_hideView"><font color="red"><i>* Please select Source of Activity first</i></font></small>
                                                </div>
                                            </div>
                                            <div class="row">                                                
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8 selectContainer">
                                                            <select class="form-control" name="map_inputParam_id" id="map_inputParam_id"></select>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-md-4 control-label"><font color="red">*</font> Consumable Span Gas</label>
                                                        <div class="col-md-8">
                                                            <input type="text" class="form-control" name="map_consParam_reference" id="map_consParam_reference"/>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8 selectContainer">
                                                            <select class="form-control" name="map_consParam_method" id="map_consParam_method">
                                                                <option value=""></option>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <div class="input-group">      
                                                                <input type="text" name="map_consParam_dataGeneration" id="map_consParam_dataGeneration" class="form-control"/>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" name="map_consParam_rangeFromLow" id="map_consParam_rangeFromLow" class="form-control"/>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" name="map_consParam_rangeToLow" id="map_consParam_rangeToLow" class="form-control"/>
                                                                <span class="input-group-addon">m</span>       
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="input-group">
                                                                <span class="input-group-addon bg-color-white">From</span>       
                                                                <input type="text" name="map_consParam_rangeFromHigh" id="map_consParam_rangeFromHigh" class="form-control"/>
                                                                <span class="input-group-addon">m</span>       
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="input-group">
                                                                <span class="input-group-addon bg-color-white">To</span>       
                                                                <input type="text" name="map_consParam_rangeToHigh" id="map_consParam_rangeToHigh" class="form-control"/>
                                                                <span class="input-group-addon">m</span>       
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <div class="col-md-12">
                                                            <button type="button" class="btn btn-labeled btn-primary pull-right" id="map_btn_add_parameter">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <table class="table table-bordered margin-bottom-5" id="datatable_map_consParam"> 
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="text-center bg-color-teal txt-color-white" data-hide="phone,tablet">Reference Traceability</th>                       
                                ...
                                <div class="step-pane" id="map_step4" data-step="4">
                                    <form class="form-horizontal" id="form_map_4" method="post">
                                        <div class="row padding-top-15">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7 map_checkView">
                                                        <div class="input-group pull-right">
                                                            <input class="form-control map_form_check" placeholder="Remark" type="text" name="map_check_remark_19" id="map_check_remark_19">
                                                            <span class="input-group-addon">
                                                                <span class="onoffswitch">
                                                                    <input type="checkbox" class="onoffswitch-checkbox map_form_check" name="map_check_pass_19" id="map_check_pass_19">
                                                                    <label class="onoffswitch-label" for="map_check_pass_19"> 
                                                                        <span class="onoffswitch-inner" data-swchon-text="Pass" data-swchoff-text="Fail"></span> 
                                                                        <span class="onoffswitch-switch"></span> 
                                                                    </label> 
                                                                </span>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        <label class="radio radio-inline">
                                                            <input type="radio" class="radiobox" name="map_consAll_qaFreqDaily" value="1" /><span>Yes</span> 
                                                        </label>
                                                        <label class="radio radio-inline">
                                                            <input type="radio" class="radiobox" name="map_consAll_qaFreqDaily" value="2" /><span>No</span> 
                                                        </label>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        <label class="radio radio-inline">
                                                            <input type="radio" class="radiobox" name="map_consAll_qaMethod" value="1" /><span>Automatic</span> 
                                                        </label>
                                                        <label class="radio radio-inline">
                                                            <input type="radio" class="radiobox" name="map_consAll_qaMethod" value="2" /><span>Manual</span> 
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row padding-top-15">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7 map_checkView">
                                                        <div class="input-group pull-right">
                                                            <input class="form-control map_form_check" placeholder="Remark" type="text" name="map_check_remark_20" id="map_check_remark_20">
                                                            <span class="input-group-addon">
                                                                <span class="onoffswitch">
                                                                    <input type="checkbox" class="onoffswitch-checkbox map_form_check" name="map_check_pass_20" id="map_check_pass_20">
                                                                    <label class="onoffswitch-label" for="map_check_pass_20"> 
                                                                        <span class="onoffswitch-inner" data-swchon-text="Pass" data-swchoff-text="Fail"></span> 
                                                                        <span class="onoffswitch-switch"></span> 
                                                                    </label> 
                                                                </span>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        <label class="radio radio-inline">
                                                            <input type="radio" class="radiobox" name="map_consAll_qaFreqQuarterly" value="1" /><span>Yes</span> 
                                                        </label>
                                                        <label class="radio radio-inline">
                                                            <input type="radio" class="radiobox" name="map_consAll_qaFreqQuarterly" value="2" /><span>No</span> 
                                                        </label>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        <div class="checkbox">
                                                            <label>
                                                                <input type="checkbox" class="checkbox map_q_qaQuarter" name="map_q_qaQuarter_id[]" value="1" ><span>Quarter 1</span>
                                                            </label>
                                                        </div>
                                                        <div class="checkbox">
                                                            <label>
                                                                <input type="checkbox" class="checkbox map_q_qaQuarter" name="map_q_qaQuarter_id[]" value="2" ><span>Quarter 2</span>
                                                            </label>
                                                        </div>
                                                        <div class="checkbox">
                                                            <label>
                                                                <input type="checkbox" class="checkbox map_q_qaQuarter" name="map_q_qaQuarter_id[]" value="3" ><span>Quarter 3</span>
                                                            </label>
                                                        </div>
                                                        <div class="checkbox">
                                                            <label>
                                                                <input type="checkbox" class="checkbox map_q_qaQuarter" name="map_q_qaQuarter_id[]" value="4" ><span>Quarter 4</span>
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row padding-top-15">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7 map_checkView">
                                                        <div class="input-group pull-right">
                                                            <input class="form-control map_form_check" placeholder="Remark" type="text" name="map_check_remark_21" id="map_check_remark_21">
                                                            <span class="input-group-addon">
                                                                <span class="onoffswitch">
                                                                    <input type="checkbox" class="onoffswitch-checkbox map_form_check" name="map_check_pass_21" id="map_check_pass_21">
                                                                    <label class="onoffswitch-label" for="map_check_pass_21"> 
                                                                        <span class="onoffswitch-inner" data-swchon-text="Pass" data-swchoff-text="Fail"></span> 
                                                                        <span class="onoffswitch-switch"></span> 
                                                                    </label> 
                                                                </span>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        <label class="radio radio-inline">
                                                            <input type="radio" class="radiobox" name="map_consAll_qaFreqYearly" value="1" /><span>Yes</span> 
                                                        </label>
                                                        <label class="radio radio-inline">
                                                            <input type="radio" class="radiobox" name="map_consAll_qaFreqYearly" value="2" /><span>No</span> 
                                                        </label>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        <div class="radio">
                                                            <label>
                                                                <input type="radio" class="radiobox" name="map_y_qaQuarter_id" value="1" ><span>Quarter 1</span>
                                                            </label>
                                                        </div>
                                                        <div class="radio">
                                                            <label>
                                                                <input type="radio" class="radiobox" name="map_y_qaQuarter_id" value="2" ><span>Quarter 2</span>
                                                            </label>
                                                        </div>
                                                        <div class="radio">
                                                            <label>
                                                                <input type="radio" class="radiobox" name="map_y_qaQuarter_id" value="3" ><span>Quarter 3</span>
                                                            </label>
                                                        </div>
                                                        <div class="radio">
                                                            <label>
                                                                <input type="radio" class="radiobox" name="map_y_qaQuarter_id" value="4" ><span>Quarter 4</span>
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>
